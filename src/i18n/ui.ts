...
export const ui = {
  es: {
    ...
    'projects.groovy.title': 'Groovy Overlay para StreamElements',
    'projects.groovy.desc': 'Sistema compuesto por una extensión de Chrome y un servidor Node.js que captura la canción actual de StreamElements y la muestra en tiempo real en un overlay de OBS.',
  ...
  en: {
    ...
    'projects.groovy.title': 'Groovy Overlay for StreamElements',
    'projects.groovy.desc': 'System composed of a Chrome extension and a Node.js server that captures the current song from StreamElements and displays it in real-time on an OBS overlay.',
